...
| M4 台股規則與成本 | `in_progress` | [M4 規則與成本契約](contracts/m4-market-rules-contract.md)、參考實作 `m4/`、**118 passed** | 零股、tick、漲跌停、停牌、費用、稅、T+2 有規則與邊界測試 | 檔位由 406,445 筆官方收盤價實測推導；漲跌停三種情形皆以官方公布值驗證——一般日、除權息日 1,649/1,649（[M4.1](evidence/m4-1-ex-rights-limits-2026-08-19.md)，含法規原文封存）、減資恢復日 20/20。**M0 的三項規則缺口已全部關閉，剩餘唯一阻擋項為上游化至 Taiwan Core**。**券商費率不阻擋 M4**（M0 只要求條款可設定），它阻擋的是 M10 |
