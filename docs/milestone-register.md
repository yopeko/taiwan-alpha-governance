...
| M7 Nested validation | `pending` | - | sealed OOS 未被重複選模、baseline 公平 | **前置已解除**（2026-08-26/27）：[候選報告契約 v1.2.0](contracts/candidate-report-contract.md) 與產生器落地，ADR-0002 六條驗證測試全數實作；[對照比較契約 v1.1.0](contracts/control-comparison-contract.md) 定義候選之間的兩兩比較。**尚缺**：sealed OOS 的切分方法，以及 M7 自己的產物規格 |
